...
public class AromaSpeedModel extends GeoModel<AromaBlockEntity> {

    public AromaSpeedModel() {}
    ...
    public ResourceLocation getModelResource(AromaBlockEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath("createbeyondlimits", "geo/aroma_speed.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(AromaBlockEntity animatable) {
        // For SpeedModel, change this to aroma_speed.png, etc.
        return ResourceLocation.fromNamespaceAndPath("createbeyondlimits", "textures/block/aroma_speed.png");
    }

    @Override
    public ResourceLocation getAnimationResource(AromaBlockEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath("createbeyondlimits", "animations/aroma_speed.animation.json");
    }
