...
public class AromaStrengthModel extends GeoModel<AromaBlockEntity> {

    public AromaStrengthModel() {}
    ...
    public ResourceLocation getModelResource(AromaBlockEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath("createbeyondlimits", "geo/aroma_strength.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(AromaBlockEntity animatable) {
        // For SpeedModel, change this to aroma_speed.png, etc.
        return ResourceLocation.fromNamespaceAndPath("createbeyondlimits", "textures/block/aroma_strength.png");
    }

    @Override
    public ResourceLocation getAnimationResource(AromaBlockEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath("createbeyondlimits", "animations/aroma_strength.animation.json");
    }
